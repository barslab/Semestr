...
<div class="container">
    <div class="large-offset-3 large-6 columns">
        ...
        <form class="form-signin" id="login-form" method="post">
            <h1 class="noneback">
                <center>Добавление симптома</center>
            </h1>
            <input class="input-block-level" id="name-field" name="name" type="text"
                   placeholder="Введите название симптома" required/>
            <textarea class="form-control" rows="5" name="more_information" placeholder="Введите подробное описание симптома" required/></textarea><br>
            <center><input class="button" type="submit" value="Добавить симптом"></center>
        </form>
    </div>
</div>
