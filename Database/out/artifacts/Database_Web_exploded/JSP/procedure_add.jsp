...
<div class="container">
    <div class="large-offset-3 large-6 columns">
        ...
        <form class="form-signin" id="login-form" method="post">
            <h1 class="noneback">
                <center>Добавление процедуры</center>
            </h1>
            <input class="input-block-level" id="name-field" name="name" type="text"
                   placeholder="Введите название процедуры" required/>
            <textarea class="form-control" rows="5" name="recommendation" placeholder="Введите рекомендации к процедуре" required/></textarea><br>
            <center><input class="button" type="submit" value="Добавить процедуру"></center>
        </form>
    </div>
</div>
