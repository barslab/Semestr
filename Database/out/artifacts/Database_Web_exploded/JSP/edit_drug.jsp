        ...
        <form class="form-signin" id="login-form" method="post">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    %>
                    <label><input type="checkbox" name="drugs2" value="<%=substitutes_drug.get(i).getId()%>" checked><a title="Количество на складе: <%=substitutes_drug.get(i).getQuantity()%>" href="/drug/<%=substitutes_drug.get(i).getId()%>" target="_blank">
                    ...
                    %>
                    <label><input type="checkbox" name="drugs2" value="<%=other_drug.get(i).getId()%>"><a title="Количество на складе: <%=other_drug.get(i).getQuantity()%>" href="/drug/<%=other_drug.get(i).getId()%>" target="_blank">
